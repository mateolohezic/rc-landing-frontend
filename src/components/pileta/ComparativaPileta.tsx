  ...
  return (
    <section className="w-full py-20 lg:py-28 px-4 bg-black">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Tabla comparativa — un solo grid container para que las columnas alineen entre filas */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
        ...
        >
          <div className="grid grid-cols-[1.2fr_1fr_1fr] sm:grid-cols-[1.5fr_1fr_1fr]">
            {/* Header row */}
            <div className="p-3 lg:p-5 border-b border-white/10 bg-black/40" />
            <div className="p-3 lg:p-5 text-center bg-gradient-to-b from-red-600/15 to-transparent border-l border-b border-white/10">
            ...
            <div className="p-3 lg:p-5 text-center border-l border-b border-white/10">
            ...
            {rows.map((r, i) => {
              ...
              const borderBottom = isLast ? '' : 'border-b border-white/5';
              return (
                <div key={r.feature} className="contents">
                  <div className={`p-3 lg:p-5 flex items-center ${borderBottom}`}>
                  ...
                  <div className={`p-3 lg:p-5 border-l border-white/10 flex items-start gap-2 lg:gap-3 ${borderBottom}`}>
                    <FiX className="text-white/30 shrink-0 mt-0.5 text-lg lg:text-xl" />
                    <span className="text-xs lg:text-sm text-white/50 leading-snug">
                      {r.otros}
                    </span>
                  </div>
                </div>
