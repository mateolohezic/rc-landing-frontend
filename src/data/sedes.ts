...
export const sedes: Sede[] = [
    ...
    },
    {
        ...
        schedule: [
            ...
            { time: "09:00", lun: ["Spinning"], mie: ["Spinning"], vie: ["Spinning"] },
            { time: "10:30", sab: ["GAP"] },
            { time: "15:00", lun: ["Yoga"], mar: ["Stretching"], mie: ["Yoga"], jue: ["Stretching"], vie: ["Yoga"] },
            { time: "16:00", mar: ["Step"], jue: ["Step"] },
        ...
        precios: { mensual: 72000, debitoAutomatico: 57000, trimestral: 183000, semestral: 342000 },
    },
    {
        slug: 'barrio-norte',
        title: "Barrio Norte",
